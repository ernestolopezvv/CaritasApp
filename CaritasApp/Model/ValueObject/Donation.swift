...
struct Donation: Codable {
    ...
    init(/*fecha_creacion:Date,*/precio_total_reportado: Double, peso_total_reportado:Double, estado_factura:String, estado_recepcion_almacen: String/*, estado_recepcion_chofer: Bool, almacen_destino: String, precio_total_recibido: Double, peso_total_recibido: Double*/, articulos_donados: [ItemInDonation]){
